...
- #### WindDirectionality
At a value of 1, **WindDirectionality** eliminates waves traveling upwind, while at 0, it balances upwind and downwind waves. A value around 0.6 works well for most cases.<br/>
